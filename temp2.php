		...
		<div class="container">
			...
			<div class="nav-collapse">
				<ul class="nav pull-right">
					<li><a href="http://www.craftery.ie/NEW/necklaces.php">Necklaces</a></li>
					<li><a href="http://www.craftery.ie/NEW/bracelets.php">Bracelets</a></li>
					<li><a href="http://www.craftery.ie/NEW/earrings.php">Earrings</a></li>
					<li><a href="http://www.craftery.ie/NEW/sets.php">Sets</a></li>
					<li class="divider-vertical"></li>
					<li><a href="http://blog.craftery.ie">Blog</a></li>
					<li><a href="http://www.craftery.ie/NEW/contact.php">Contact</a></li>
					<li class="divider-vertical"></li>
					<li><a href="http://www.craftery.ie/NEW/index.php">Home</a></li>
				</ul> 
			</div>
		</div> <!-- container -->
	</div> <!-- fill -->
